...
#
# Using the slice operator, assign a new tuple containing only the last two food strings in the foods to a variable
# named last_two_foods.


def slice_foods():
    # your code here
    foods = ("Burger", "Pancake", "Steak", "Pizza")
...
def hometown_info():
    # your code here
    home_town = {"city": "Bahrain", "state": "Manama", "population": 100000}
